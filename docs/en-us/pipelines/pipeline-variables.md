...
| ImportArtifacts.AppExcludeExpr    |                             |                         | The regex expression that is used to exclude apps from being published during the *Import Artifacts* step in the pipeline. The default is `.*Test_.*|.*Tests_.*`                                                                                                                                                       |
