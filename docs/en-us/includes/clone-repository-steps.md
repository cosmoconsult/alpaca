...
1. Right-click on the repository that you want to use and select **Clone** or use the action next to it
...
1. After opening the repository, VS Code will recognize that it contains a workspace and ask you whether you want to open it. Click on **Open Workspace** as development will work best in the workspace.