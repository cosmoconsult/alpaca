...
All the feeds visible in the Packages View are also available in Alpaca containers as a source of dependency [artifacts](../github/setup-artifacts.md#nuget-feed).
