...
## [Favorite or Hide Organizations & Repositories](favorite-orgs.md)

## [Hybrid Working — Azure DevOps & GitHub](hybrid-working.md)

## [Work with Issues and Work Items](interact-with-requirements.md)
...
## [Contribute to Base App](contribute-base-app.md)

# COSMO-only Features

## [Assign Repository to Entity](assign-entity.md)

## [Assign Repository to Customer](assign-customer.md)

## [Preconfigured Build Modes](preconfigured-build-modes.md)