...
To configure custom CodeCops, follow the documentation on [customCodeCops](https://aka.ms/algosettings#customCodeCops) in the Microsoft AL-Go documentation. You can define custom CodeCops in your workflow-specific settings files (e.g., `.github/CICD.settings.json`) or in project-specific settings files (e.g., `<project>/.AL-Go/settings.json`).
