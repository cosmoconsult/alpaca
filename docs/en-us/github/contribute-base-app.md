...
1. If you haven't got the newest AL extension and you see errors, you might need to set the runtime in app.json to 12.0
1. Now you're ready to go. Publish with F5 and enter your username and the generated password you copied earlier to access the web client.
