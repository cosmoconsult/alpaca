...
- Add support for File Browser share links with nested paths and SaaS backup artifacts in container requests
...
- Revert dedicated namespace resolution for external GitHub collaborators
...
- Add environment name setting for Business Central container launch configurations
...
- Add new endpoint to retrieve a specific GitHub owner
...
- Optimized ruleset handling for required status checks
  ...
  - Fix issue with insufficient permissions or GitHub plans for managing rulesets
