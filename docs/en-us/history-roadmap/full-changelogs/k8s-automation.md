---
    title: Kubernetes Automation Backend Changelog
    description: Kubernetes Automation Backend Changelog
    orig-source: https://dev.azure.com/cc-ppi/Self-Service/_git/docker-automation?path=%2FCHANGELOG.md&version=GBk8s
---

# Change Log

All notable changes to the Kubernetes Automation Backend
...
- Optionally auto shutdown BC containers in the night, only containers running for a certain time (default 6h) are stopped  (https://dev.azure.com/cc-ppi/Self-Service/_workitems/edit/2495)
- Remove disableHttp2 implementation as it was wrong and caused issues with newer Traefik versions (https://dev.azure.com/cc-ppi/Self-Service/_workitems/edit/2500)
- Add Accept-encoding header by default as the combination of Traefik and BC otherwise has issues (https://dev.azure.com/cc-ppi/Self-Service/_workitems/edit/2501)
- Notify about build containers that are excluded from the limits (https://dev.azure.com/cc-ppi/Self-Service/_workitems/edit/2524/)
...
- Suppress output messages when importing BCCH as it messes with result interpreation (https://dev.azure.com/cc-ppi/Self-Service/_workitems/edit/1912)
...
- Support regenerating cosmoartifact images on container start (https://dev.azure.com/cc-ppi/General/_workitems/edit/1460)
