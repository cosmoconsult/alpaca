...
- Add setting to trigger behavior that only shows the branches created by the current user and defailt branches (main/master) (https://dev.azure.com/cc-ppi/General/_workitems/edit/2606/)
