...
Please note that external users now need to [switch to your tenant](tenant.md) to work in your organization and might want to create separate VS Code profiles if they use Alpaca in multiple tenants.
...
Please note that developers now need to [switch to the customer tenant](tenant.md) to work in the customer organization and should create different VS Code profiles for the different tenants.
