...
1. After your container was created, the color of the icon shows the status of the container. The yellow icon indicates that the container is starting. As soon as the icon turns blue, the container is ready to access it.
