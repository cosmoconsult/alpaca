...
> [!TIP]
> The screenshots/videos below are from the **Legacy Extension**. The workflow in the current **COSMO Alpaca extension** is the same, but the UI may look slightly different.
