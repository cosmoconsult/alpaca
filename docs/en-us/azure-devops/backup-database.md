...
You can then use your usual way to access the file share and work with the backup. You can also use it to create a new container by specifying it as backup file (see [Setup Database Backup](setup-bak.md)).
