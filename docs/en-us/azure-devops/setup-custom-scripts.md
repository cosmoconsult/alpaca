...
To test changes to your custom scripts from a separate branch you can use [the option to create a container with configuration in a branch](create-container.md#create-a-container-with-configuration-from-a-specific-branch) in the Visual Studio Code Extension.
