---
    title: Get Container Credentials
    description: Get Container Credentials
---
...
You can read the docs on [how to open the Business Central Web Client](access-container-resources.md). To quickly copy your username and password to login right click on your Container in the Visual Studio Code extension either choose **Copy password to clipboard** or **Copy username to clipboard**.
