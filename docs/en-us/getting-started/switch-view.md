---
    ...
    description: Switch Platform View
---
...
![Switch View GitHub](../media/switch-view-github.png)
![Switch View Azure DevOps](../media/switch-view-devops.png)

And in the settings of the extension:

![Switch View Setting](../media/view-settings-platform.png)
...
![Switch View Mode Setting](../media/view-settings-mode.png)