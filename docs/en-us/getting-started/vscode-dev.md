...
> **Tip:** Need to create a new organization? See our [Create organization guide](../github/create-org.md) for instructions on setting up organizations in COSMO Alpaca.
